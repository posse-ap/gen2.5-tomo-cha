...
VALUES 
    (1, 1, 'たかわ', 0), (1, 1, 'こうわ', 0), (1, 1, 'たかなわ', 1),
    ...
    (2, 2, 'みよし', 0), (2, 2, 'おしらべ', 0), (2, 2, 'みつぎ', 1),
    (2, 3, 'ぎんざん', 0), (2, 3, 'きやま', 0), (2, 3, 'かなやま', 1),
    (2, 4, 'とよか', 0), (2, 4, 'としか', 0), (2, 4, 'とよひ', 1),
    (2, 5, 'いしあぜ', 0), (2, 5, 'しゃくぜ', 0), (2, 5, 'いしぐろ', 1),
    (2, 6, 'みつぎ', 0), (2, 6, 'みかた', 0), (2, 6, 'みよし', 1),
    (2, 7, 'くもおり', 0), (2, 7, 'もみち', 0), (2, 7, 'うずい', 1),
    (2, 8, 'ぽんかん', 0), (2, 8, 'でこぽん', 0), (2, 8, 'すもも', 1),
    (2, 9, 'おうちごとうげ', 0), (2, 9, 'おおちごえとうげ', 0), (2, 9, 'おおちごとうげ', 1),
    (2, 10, 'てっぽよばら', 0), (2, 10, 'ていぼよはら', 0), (2, 10, 'よおろほよばら', 1);