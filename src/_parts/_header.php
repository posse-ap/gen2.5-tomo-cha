...
<body>
    <header class="header">
        <div class="header_contents_wrapper">
            <ul class="header_list_left">
                <li id="headerListItemHumburger" class="header_list_item_humburger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
